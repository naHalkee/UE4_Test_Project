...
void AMyProjectCharacter::SpawnNewToy()
{
	CurrentToy = GetWorld()->SpawnActor<ATarget>(TargetsTemplates[IndexOFToyType], GetActorLocation()+GetActorForwardVector()*100, GetActorRotation());
	CurrentToy->AttachToActor(this, FAttachmentTransformRules::KeepWorldTransform);
}
...
void AMyProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindKey(EKeys::R, IE_Pressed, this, &AMyProjectCharacter::ChangeToy);
	PlayerInputComponent->BindKey(EKeys::E, IE_Pressed, this, &AMyProjectCharacter::DropToy);
}
